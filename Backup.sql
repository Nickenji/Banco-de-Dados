...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2019-11-10 16:20:05',NULL),('diagnostics.include_raw','OFF','2019-11-10 16:20:05',NULL),('ps_thread_trx_info.max_length','65535','2019-11-10 16:20:05',NULL),('statement_performance_analyzer.limit','100','2019-11-10 16:20:05',NULL),('statement_performance_analyzer.view',NULL,'2019-11-10 16:20:05',NULL),('statement_truncate_len','64','2019-11-10 16:20:05',NULL);
...
-- Dump completed on 2019-11-29  1:34:52
-- MySQL dump 10.13  Distrib 8.0.18, for Win64 (x86_64)
--
...
CREATE TABLE `acompanha` (
  ...
  `URL_pagina` char(50) NOT NULL,
  PRIMARY KEY (`CPF`,`URL_pagina`),
  UNIQUE KEY `ID_Acompanha_IND` (`CPF`,`URL_pagina`),
  KEY `FKAco_Red_IND` (`URL_pagina`),
  CONSTRAINT `FKAco_Pes` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`),
  CONSTRAINT `FKAco_Red_FK` FOREIGN KEY (`URL_pagina`) REFERENCES `redes_sociais` (`URL_pagina`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `acompanha` VALUES (15514957756,'www.feicebuqui.com/Associação_dos_estudantes'),(53260023615,'www.feicebuqui.com/Associação_dos_estudantes'),(60023773600,'www.feicebuqui.com/Associação_dos_estudantes'),(25631281619,'www.feicebuqui.com/Associação_dos_profissionais'),(32571586610,'www.feicebuqui.com/Associação_dos_profissionais'),(97416461006,'www.feicebuqui.com/Associação_dos_profissionais'),(14429552797,'www.feicebuqui.com/chare'),(20482380500,'www.feicebuqui.com/chare'),(53260023615,'www.feicebuqui.com/Conselho_da_biologia'),(60023773600,'www.feicebuqui.com/Conselho_da_biologia'),(97416461006,'www.feicebuqui.com/Conselho_da_biologia'),(25631281619,'www.feicebuqui.com/Conselho_econômico'),(48775807351,'www.feicebuqui.com/Conselho_econômico'),(76880861083,'www.feicebuqui.com/Conselho_econômico'),(25631281619,'www.feicebuqui.com/decore'),(32571586610,'www.feicebuqui.com/decore'),(25631281619,'www.feicebuqui.com/Myxr'),(32571586610,'www.feicebuqui.com/Myxr'),(97416461006,'www.feicebuqui.com/Myxr'),(20482380500,'www.feicebuqui.com/sentri'),(48775807351,'www.feicebuqui.com/sentri'),(76880861083,'www.feicebuqui.com/sentri'),(14429552797,'www.feicebuqui.com/Sindicato_artistico'),(50847006409,'www.feicebuqui.com/Sindicato_artistico'),(78655763748,'www.feicebuqui.com/Sindicato_artistico'),(25631281619,'www.feicebuqui.com/sindicato_dos_psicólogos'),(48775807351,'www.feicebuqui.com/sindicato_dos_psicólogos'),(76880861083,'www.feicebuqui.com/sindicato_dos_psicólogos'),(15514957756,'www.feicebuqui.com/spack'),(60023773600,'www.feicebuqui.com/spack'),(48775807351,'www.feicebuqui.com/storela'),(76880861083,'www.feicebuqui.com/storela'),(53260023615,'www.feicebuqui.com/tstore'),(97416461006,'www.feicebuqui.com/tstore'),(32571586610,'www.feicebuqui.com/uniesquina'),(53260023615,'www.feicebuqui.com/uniesquina'),(97416461006,'www.feicebuqui.com/uniesquina'),(15514957756,'www.feicebuqui.com/Universidade_SCG'),(53260023615,'www.feicebuqui.com/Universidade_SCG'),(60023773600,'www.feicebuqui.com/Universidade_SCG');
...
CREATE TABLE `alimento` (
  `Nota_servico` bigint(20) NOT NULL,
  `Tipos_comida` char(15) NOT NULL,
  `Data` date NOT NULL,
  `Valor` decimal(6,2) NOT NULL,
  PRIMARY KEY (`Nota_servico`),
  UNIQUE KEY `ID_Alimento_IND` (`Nota_servico`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `alimento` VALUES (1,'Pão','2019-08-10',50.00),(2,'Suco','2019-12-18',150.00),(3,'Água','2019-05-01',30.00),(4,'Café','2019-10-29',200.00),(5,'Frutas','2019-03-01',180.00);
...
CREATE TABLE `apresenta` (
  ...
  UNIQUE KEY `ID_Apresenta_IND` (`CPF`,`ID_Atividade`),
  KEY `FKApr_Wor_IND` (`ID_Atividade`),
  KEY `EQU_Apres_Atvd_IND` (`ID_Atividade`),
  CONSTRAINT `EQU_Apres_Atvd_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`),
  CONSTRAINT `FKApr_Pes` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`),
  CONSTRAINT `FKApr_Wor_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`),
  CONSTRAINT `REF_Apres_Pessoa` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `apresenta` VALUES (72360474812,1),(4657782754,2),(97657457376,3),(98216250290,4),(51782730281,5),(78655763748,6),(50847006409,7),(14429552797,8),(20482380500,9),(48775807351,10),(79580496412,11),(4657782754,12),(10089321162,13),(76880861083,14),(10426777948,15),(14429552797,16),(77212921661,17),(50847006409,18),(97416461006,19),(98216250290,20),(20482380500,21),(60023773600,22),(32571586610,23),(78655763748,24),(53260023615,25),(15514957756,26),(53260023615,27),(93204873676,28),(76880861083,29),(25631281619,30),(72360474812,31),(10089321162,32),(79580496412,33),(97657457376,34),(98216250290,35);
/*!40000 ALTER TABLE `apresenta` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `apresentacao_artigo`
--

DROP TABLE IF EXISTS `apresentacao_artigo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `apresentacao_artigo` (
  `ID_Atividade` int(11) NOT NULL,
  `tipo_artigo` varchar(200) DEFAULT NULL,
  `Autor_Artigo` char(15) NOT NULL,
  `Numero_Sessoes` varchar(1) NOT NULL,
  `nome_sessao` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`ID_Atividade`),
  UNIQUE KEY `FKAti_Apr_IND` (`ID_Atividade`),
  UNIQUE KEY `ID_ApArtg_Atvd_IND` (`ID_Atividade`),
  CONSTRAINT `FKAti_Apr_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`),
  CONSTRAINT `ID_ApArtg_Atvd_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `apresentacao_artigo`
--

LOCK TABLES `apresentacao_artigo` WRITE;
/*!40000 ALTER TABLE `apresentacao_artigo` DISABLE KEYS */;
INSERT INTO `apresentacao_artigo` VALUES (26,'Investimento: Sorte ou Análise?','Helder','1','Apresentação final'),(27,'Uso de inteligência artificial para nunca mais ter que trabalhar','Gerson','1','Tese de mestrado'),(28,'Criando clones','Sara','1','Tese de doutorado'),(29,'O número depois do infinito','Mariana','1','Apresentação final'),(30,'Modificação quantica','Daniela','1','TCC');
/*!40000 ALTER TABLE `apresentacao_artigo` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `atividade` (
  `ID_Atividade` int(11) NOT NULL,
  `Data` date NOT NULL,
  `local` char(50) DEFAULT NULL,
  `ID_Evento` char(20) NOT NULL,
  `Workshop` int(11) DEFAULT NULL,
  `Tutorial` int(11) DEFAULT NULL,
  `Reuniao` int(11) DEFAULT NULL,
  `Palestra` int(11) DEFAULT NULL,
  `Concurso` int(11) DEFAULT NULL,
  `Atividade_Social` int(11) DEFAULT NULL,
  `Apresentacao_Artigo` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID_Atividade`),
  UNIQUE KEY `ID_Atividade_IND` (`ID_Atividade`),
  KEY `FKTem_IND` (`ID_Evento`),
  CONSTRAINT `EQU_Atvd_Evnt_FK` FOREIGN KEY (`ID_Evento`) REFERENCES `evento` (`ID_Evento`),
  CONSTRAINT `FKTem_FK` FOREIGN KEY (`ID_Evento`) REFERENCES `evento` (`ID_Evento`),
  CONSTRAINT `EXTONE_Atividade` CHECK ((((`Atividade_Social` is not null) and (`Concurso` is null) and (`Apresentacao_Artigo` is null) and (`Reuniao` is null) and (`Tutorial` is null) and (`Workshop` is null) and (`Palestra` is null)) or ((`Atividade_Social` is null) and (`Concurso` is not null) and (`Apresentacao_Artigo` is null) and (`Reuniao` is null) and (`Tutorial` is null) and (`Workshop` is null) and (`Palestra` is null)) or ((`Atividade_Social` is null) and (`Concurso` is null) and (`Apresentacao_Artigo` is not null) and (`Reuniao` is null) and (`Tutorial` is null) and (`Workshop` is null) and (`Palestra` is null)) or ((`Atividade_Social` is null) and (`Concurso` is null) and (`Apresentacao_Artigo` is null) and (`Reuniao` is not null) and (`Tutorial` is null) and (`Workshop` is null) and (`Palestra` is null)) or ((`Atividade_Social` is null) and (`Concurso` is null) and (`Apresentacao_Artigo` is null) and (`Reuniao` is null) and (`Tutorial` is not null) and (`Workshop` is null) and (`Palestra` is null)) or ((`Atividade_Social` is null) and (`Concurso` is null) and (`Apresentacao_Artigo` is null) and (`Reuniao` is null) and (`Tutorial` is null) and (`Workshop` is not null) and (`Palestra` is null)) or ((`Atividade_Social` is null) and (`Concurso` is null) and (`Apresentacao_Artigo` is null) and (`Reuniao` is null) and (`Tutorial` is null) and (`Workshop` is null) and (`Palestra` is not null))))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `atividade` VALUES (1,'2019-08-10','Coworking Space','1',NULL,1,NULL,NULL,NULL,NULL,NULL),(2,'2019-03-20','Parque Verde','2',NULL,1,NULL,NULL,NULL,NULL,NULL),(3,'2019-07-12','Town Hall','4',NULL,1,NULL,NULL,NULL,NULL,NULL),(4,'2019-10-30','Anfiteatro','6',NULL,1,NULL,NULL,NULL,NULL,NULL),(5,'2019-09-18','Anfiteatro','5',NULL,1,NULL,NULL,NULL,NULL,NULL),(6,'2019-12-18','Coworking Space','7',1,NULL,NULL,NULL,NULL,NULL,NULL),(7,'2019-05-01','Coworking Space','3',1,NULL,NULL,NULL,NULL,NULL,NULL),(8,'2019-10-29','Coworking Space','6',1,NULL,NULL,NULL,NULL,NULL,NULL),(9,'2019-07-13','Town Hall','4',1,NULL,NULL,NULL,NULL,NULL,NULL),(10,'2019-12-18','Arena Big','7',1,NULL,NULL,NULL,NULL,NULL,NULL),(11,'2019-05-01','Coworking Space','3',NULL,NULL,1,NULL,NULL,NULL,NULL),(12,'2019-03-01','Coworking Space','2',NULL,NULL,1,NULL,NULL,NULL,NULL),(13,'2019-08-01','Coworking Space','1',NULL,NULL,1,NULL,NULL,NULL,NULL),(14,'2019-07-01','Coworking Space','4',NULL,NULL,1,NULL,NULL,NULL,NULL),(15,'2019-12-01','Coworking Space','7',NULL,NULL,1,NULL,NULL,NULL,NULL),(16,'2019-07-20','Anfiteatro','4',NULL,NULL,NULL,NULL,NULL,1,NULL),(17,'2019-03-27','Parque Verde','2',NULL,NULL,NULL,NULL,NULL,1,NULL),(18,'2019-08-06','Town Hall','1',NULL,NULL,NULL,NULL,NULL,1,NULL),(19,'2019-12-22','Parque Verde','7',NULL,NULL,NULL,NULL,NULL,1,NULL),(20,'2019-10-24','Anfiteatro','6',NULL,NULL,NULL,NULL,NULL,1,NULL),(21,'2019-08-12','Town Hall','1',NULL,NULL,NULL,NULL,1,NULL,NULL),(22,'2019-12-15','Arena Big','7',NULL,NULL,NULL,NULL,1,NULL,NULL),(23,'2019-12-15','Arena Big','7',NULL,NULL,NULL,NULL,1,NULL,NULL),(24,'2019-07-12','Arena Big','4',NULL,NULL,NULL,NULL,1,NULL,NULL),(25,'2019-05-10','Coworking Space','3',NULL,NULL,NULL,NULL,1,NULL,NULL),(26,'2019-10-18','Anfiteatro','6',NULL,NULL,NULL,NULL,NULL,NULL,1),(27,'2019-08-11','Anfiteatro','1',NULL,NULL,NULL,NULL,NULL,NULL,1),(28,'2019-03-17','Anfiteatro','2',NULL,NULL,NULL,NULL,NULL,NULL,1),(29,'2019-05-04','Anfiteatro','3',NULL,NULL,NULL,NULL,NULL,NULL,1),(30,'2019-09-14','Anfiteatro','5',NULL,NULL,NULL,NULL,NULL,NULL,1),(31,'2019-08-19','Anfiteatro','1',NULL,NULL,NULL,1,NULL,NULL,NULL),(32,'2019-03-24','Anfiteatro','2',NULL,NULL,NULL,1,NULL,NULL,NULL),(33,'2019-12-29','Anfiteatro','7',NULL,NULL,NULL,1,NULL,NULL,NULL),(34,'2019-07-24','Anfiteatro','4',NULL,NULL,NULL,1,NULL,NULL,NULL),(35,'2019-10-25','Anfiteatro','6',NULL,NULL,NULL,1,NULL,NULL,NULL);
...
CREATE TABLE `atividade_social` (
  `ID_Atividade` int(11) NOT NULL,
  `tipo_a_social` varchar(200) DEFAULT NULL,
  `Valor` int(11) NOT NULL,
  PRIMARY KEY (`ID_Atividade`),
  UNIQUE KEY `FKAti_Ati_IND` (`ID_Atividade`),
  UNIQUE KEY `ID_AtvSocial_Atvd_IND` (`ID_Atividade`),
  CONSTRAINT `FKAti_Ati_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`),
  CONSTRAINT `ID_AtvSocial_Atvd_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `atividade_social` VALUES (16,'Reduzir a fome',0),(17,'Plantar árvores',0),(18,'Inclusão tecnológica',0),(19,'Lazer para todos',0),(20,'Ensinando a economizar',0);
...
CREATE TABLE `auditorio` (
  `CNPJ_Local` bigint(20) NOT NULL,
  `ID_Sala` int(11) NOT NULL,
  `Pessoas_Suportadas` int(11) NOT NULL,
  PRIMARY KEY (`CNPJ_Local`),
  UNIQUE KEY `FKLoc_Aud_IND` (`CNPJ_Local`),
  UNIQUE KEY `ID_Audit_Local_IND` (`CNPJ_Local`),
  CONSTRAINT `FKLoc_Aud_FK` FOREIGN KEY (`CNPJ_Local`) REFERENCES `local` (`CNPJ_Local`),
  CONSTRAINT `ID_Audit_Local_FK` FOREIGN KEY (`CNPJ_Local`) REFERENCES `local` (`CNPJ_Local`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `auditorio` VALUES (10175464000192,2,100),(80599449000157,3,50),(93152678000170,1,20);
...
CREATE TABLE `certificado` (
  `ID_Ceritificado` bigint(20) NOT NULL,
  `Data` date NOT NULL,
  `evento` varchar(200) DEFAULT NULL,
  `CPF` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID_Ceritificado`),
  UNIQUE KEY `ID_Certificado_IND` (`ID_Ceritificado`),
  KEY `FKRecebe_IND` (`CPF`),
  CONSTRAINT `FKRecebe_FK` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`),
  CONSTRAINT `REF_Certf_Pessoa_FK` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `certificado` VALUES (1,'2019-08-10','Aprendendo a desenvolver websites',15514957756),(2,'2019-08-10','Aprendendo a desenvolver websites',53260023615),(3,'2019-08-10','Aprendendo a desenvolver websites',60023773600),(4,'2019-03-20','Criando o seu próprio jardim',53260023615),(5,'2019-03-20','Criando o seu próprio jardim',60023773600),(6,'2019-03-20','Criando o seu próprio jardim',97416461006),(7,'2019-07-12','Como fazer sushi',32571586610),(8,'2019-07-12','Como fazer sushi',53260023615),(9,'2019-07-12','Como fazer sushi',97416461006),(10,'2019-10-30','Entendendo a bolsa de valores em 5 passos',25631281619),(11,'2019-10-30','Entendendo a bolsa de valores em 5 passos',32571586610),(12,'2019-10-30','Entendendo a bolsa de valores em 5 passos',97416461006),(13,'2019-09-18','Mudando o mindset',25631281619),(14,'2019-09-18','Mudando o mindset',32571586610),(15,'2019-09-18','Mudando o mindset',76880861083),(16,'2019-12-18','Workshop de violão',25631281619),(17,'2019-12-18','Workshop de violão',48775807351),(18,'2019-12-18','Workshop de violão',76880861083),(19,'2019-05-01','Workshop de Matemática',76880861083),(20,'2019-05-01','Workshop de Matemática',20482380500),(21,'2019-05-01','Workshop de Matemática',48775807351),(22,'2019-10-29','Workshop de investimento',14429552797),(23,'2019-10-29','Workshop de investimento',20482380500),(24,'2019-10-29','Workshop de investimento',48775807351),(25,'2019-07-13','Workshop de culinária arábe',14429552797),(26,'2019-07-13','Workshop de culinária arábe',20482380500),(27,'2019-07-13','Workshop de culinária arábe',50847006409),(28,'2019-12-18','Workshop de dança',14429552797),(29,'2019-12-18','Workshop de dança',50847006409),(30,'2019-12-18','Workshop de dança',93204873676),(31,'2019-05-01','Organizar a Olimpiada de Matemática',10089321162),(32,'2019-05-01','Organizar a Olimpiada de Matemática',50847006409),(33,'2019-05-01','Organizar a Olimpiada de Matemática',93204873676),(34,'2019-03-01','Organizar a Olimpiada de Biologia',10089321162),(35,'2019-03-01','Organizar a Olimpiada de Biologia',79580496412),(36,'2019-03-01','Organizar a Olimpiada de Biologia',93204873676),(37,'2019-08-01','Organizar a Olimpiada de Computação',10089321162),(38,'2019-08-01','Organizar a Olimpiada de Computação',72360474812),(39,'2019-08-01','Organizar a Olimpiada de Computação',79580496412),(40,'2019-07-01','Discutir quais pratos cozinhar',72360474812),(41,'2019-07-01','Discutir quais pratos cozinhar',79580496412),(42,'2019-07-01','Discutir quais pratos cozinhar',97657457376),(43,'2019-12-01','Discutir quais eventos artísticos apresentar',4657782754),(44,'2019-12-01','Discutir quais eventos artísticos apresentar',72360474812),(45,'2019-12-01','Discutir quais eventos artísticos apresentar',97657457376),(46,'2019-07-20','Reduzir a fome',4657782754),(47,'2019-07-20','Reduzir a fome',97657457376),(48,'2019-07-20','Reduzir a fome',98216250290),(49,'2019-03-27','Plantar árvores',4657782754),(50,'2019-03-27','Plantar árvores',56706009083),(51,'2019-03-27','Plantar árvores',98216250290),(52,'2019-08-06','Inclusão tecnológica',56706009083),(53,'2019-08-06','Inclusão tecnológica',70193238209),(54,'2019-08-06','Inclusão tecnológica',98216250290),(55,'2019-12-22','Lazer para todos',51782730281),(56,'2019-12-22','Lazer para todos',56706009083),(57,'2019-12-22','Lazer para todos',70193238209),(58,'2019-10-24','Ensinando a economizar',10426777948),(59,'2019-10-24','Ensinando a economizar',51782730281),(60,'2019-10-24','Ensinando a economizar',70193238209),(61,'2019-08-12','Hackathon sobre segurança dos dados',10426777948),(62,'2019-08-12','Hackathon sobre segurança dos dados',15514957756),(63,'2019-08-12','Hackathon sobre segurança dos dados',51782730281),(64,'2019-12-15','Batalha de dança',10426777948),(65,'2019-12-15','Batalha de dança',15514957756),(66,'2019-12-15','Batalha de dança',60023773600),(67,'2019-07-12','Show das bandas',15514957756),(68,'2019-07-12','Show das bandas',53260023615),(69,'2019-07-12','Show das bandas',60023773600),(70,'2019-05-10','Desafio culinário',53260023615),(71,'2019-05-10','Desafio culinário',60023773600),(72,'2019-05-10','Desafio culinário',97416461006),(73,'2019-10-18','Calculadora humana',32571586610),(74,'2019-10-18','Calculadora humana',53260023615),(75,'2019-10-18','Calculadora humana',97416461006),(76,'2019-08-11','Investimento: Sorte ou Análise?',25631281619),(77,'2019-08-11','Investimento: Sorte ou Análise?',32571586610),(78,'2019-08-11','Investimento: Sorte ou Análise?',97416461006),(79,'2019-03-17','Uso de inteligência artificial para nunca mais ter que trabalhar',25631281619),(80,'2019-03-17','Uso de inteligência artificial para nunca mais ter que trabalhar',32571586610),(81,'2019-03-17','Uso de inteligência artificial para nunca mais ter que trabalhar',76880861083),(82,'2019-05-04','Criando clones',25631281619),(83,'2019-05-04','Criando clones',48775807351),(84,'2019-05-04','Criando clones',76880861083),(85,'2019-05-04','O número depois do infinito',20482380500),(86,'2019-05-04','O número depois do infinito',48775807351),(87,'2019-05-04','O número depois do infinito',76880861083),(88,'2019-09-14','Modificação quantica',14429552797),(89,'2019-09-14','Modificação quantica',20482380500),(90,'2019-09-14','Modificação quantica',48775807351),(91,'2019-08-19','O que é Machine Learning',14429552797),(92,'2019-08-19','O que é Machine Learning',20482380500),(93,'2019-08-19','O que é Machine Learning',50847006409),(94,'2019-03-24','Explicando o aquecimento global',14429552797),(95,'2019-03-24','Explicando o aquecimento global',50847006409),(96,'2019-03-24','Explicando o aquecimento global',78655763748),(97,'2019-12-29','O poder da diversidade',50847006409),(98,'2019-12-29','O poder da diversidade',78655763748),(99,'2019-12-29','O poder da diversidade',93204873676),(100,'2019-07-24','Culinária e suas infinidades',15514957756),(101,'2019-07-24','Culinária e suas infinidades',78655763748),(102,'2019-07-24','Culinária e suas infinidades',93204873676),(103,'2019-10-25','Dinheiro = felicidade?',15514957756),(104,'2019-10-25','Dinheiro = felicidade?',60023773600),(105,'2019-10-25','Dinheiro = felicidade?',93204873676);
...
CREATE TABLE `concurso` (
  ...
  `juizes` varchar(200) DEFAULT NULL,
  `regras` varchar(200) DEFAULT NULL,
  `premiacao` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`ID_Atividade`),
  UNIQUE KEY `FKAti_Con_IND` (`ID_Atividade`),
  UNIQUE KEY `ID_Conc_Atvd_IND` (`ID_Atividade`),
  CONSTRAINT `FKAti_Con_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`),
  CONSTRAINT `ID_Conc_Atvd_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `concurso` VALUES (21,'Hackathon sobre segurança dos dados','Aline','Não pode plagiar ideias','Notebook'),(22,'Batalha de dança','Caio','A competição é individual','Caixa de som'),(23,'Show das bandas','Julia','Banda deve estar completa para apresentação','Gravação de um disco'),(24,'Desafio culinário','Leticia','Os pratos devem ser feito em no máximo 2 horas','Fogão'),(25,'Calculadora humana','Gerson','Não pode receber auxílio de qualquer pessoa ou tecnologia','Classificação para o campeonato internacional');
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cupom` (
  `id_cupom` int(20) NOT NULL,
  `CPF` bigint(20) NOT NULL,
  `CNPJ_Loja` bigint(20) NOT NULL,
  PRIMARY KEY (`id_cupom`),
  UNIQUE KEY `ID_Cupom_IND` (`id_cupom`),
  KEY `FKDa_IND` (`CNPJ_Loja`),
  KEY `FKGanha_IND` (`CPF`),
  CONSTRAINT `FKDa_FK` FOREIGN KEY (`CNPJ_Loja`) REFERENCES `loja` (`CNPJ_Loja`),
  CONSTRAINT `FKGanha_FK` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cupom` VALUES (1,15514957756,59055965000124),(2,60023773600,59055965000124),(3,53260023615,31513697000128),(4,97416461006,31513697000128),(5,32571586610,80000025000124),(6,25631281619,80000025000124),(7,76880861083,34544011000154),(8,48775807351,34544011000154),(9,20482380500,68812697000139),(10,14429552797,68812697000139);
...
CREATE TABLE `despesa` (
  `Nota_servico` bigint(20) NOT NULL,
  `ID_Evento` char(20) NOT NULL,
  `Reserva_Hospedagem` char(1) NOT NULL,
  `Nota_Locacao` bigint(20) NOT NULL,
  `Nota_compra` bigint(20) NOT NULL,
  `No_Ticket` char(1) NOT NULL,
  PRIMARY KEY (`Nota_compra`,`Nota_servico`,`Nota_Locacao`,`No_Ticket`,`ID_Evento`,`Reserva_Hospedagem`),
  UNIQUE KEY `ID_Despesa_IND` (`Nota_compra`,`Nota_servico`,`Nota_Locacao`,`No_Ticket`,`ID_Evento`,`Reserva_Hospedagem`),
  KEY `FKDes_Pas_IND` (`No_Ticket`),
  KEY `FKDes_Loc_IND` (`Nota_Locacao`),
  KEY `FKDes_Hos_IND` (`Reserva_Hospedagem`),
  KEY `FKDes_Eve_IND` (`ID_Evento`),
  KEY `FKDes_Ali_IND` (`Nota_servico`),
  CONSTRAINT `EQU_Despe_Alment_FK` FOREIGN KEY (`Nota_servico`) REFERENCES `alimento` (`Nota_servico`),
  CONSTRAINT `EQU_Despe_Evnt_FK` FOREIGN KEY (`ID_Evento`) REFERENCES `evento` (`ID_Evento`),
  CONSTRAINT `EQU_Despe_Locacao_FK` FOREIGN KEY (`Nota_Locacao`) REFERENCES `locacao` (`Nota_Locacao`),
  CONSTRAINT `EQU_Despe_MtrlEscrt` FOREIGN KEY (`Nota_compra`) REFERENCES `material_escritorio` (`Nota_compra`),
  CONSTRAINT `FKDes_Ali_FK` FOREIGN KEY (`Nota_servico`) REFERENCES `alimento` (`Nota_servico`),
  CONSTRAINT `FKDes_Eve_FK` FOREIGN KEY (`ID_Evento`) REFERENCES `evento` (`ID_Evento`),
  CONSTRAINT `FKDes_Hos_FK` FOREIGN KEY (`Reserva_Hospedagem`) REFERENCES `hospedagem` (`Reserva_Hospedagem`),
  CONSTRAINT `FKDes_Loc_FK` FOREIGN KEY (`Nota_Locacao`) REFERENCES `locacao` (`Nota_Locacao`),
  CONSTRAINT `FKDes_Mat` FOREIGN KEY (`Nota_compra`) REFERENCES `material_escritorio` (`Nota_compra`),
  CONSTRAINT `FKDes_Pas_FK` FOREIGN KEY (`No_Ticket`) REFERENCES `passagem_aviao` (`No_Ticket`),
  CONSTRAINT `REF_Despe_Hospdg_FK` FOREIGN KEY (`Reserva_Hospedagem`) REFERENCES `hospedagem` (`Reserva_Hospedagem`),
  CONSTRAINT `REF_Despe_PasAviao_FK` FOREIGN KEY (`No_Ticket`) REFERENCES `passagem_aviao` (`No_Ticket`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `despesa` VALUES (1,'4','1',29,1,'1'),(2,'2','2',17,2,'2'),(3,'7','3',31,3,'3'),(4,'4','4',32,4,'4'),(5,'6','5',24,5,'5');
...
CREATE TABLE `divulga` (
  `ID_Atividade` int(11) NOT NULL,
  `URL_pagina` char(50) NOT NULL,
  PRIMARY KEY (`ID_Atividade`,`URL_pagina`),
  UNIQUE KEY `ID_Divulga_IND` (`ID_Atividade`,`URL_pagina`),
  KEY `FKDiv_Red_IND` (`URL_pagina`),
  CONSTRAINT `FKDiv_Ati` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`),
  CONSTRAINT `FKDiv_Red_FK` FOREIGN KEY (`URL_pagina`) REFERENCES `redes_sociais` (`URL_pagina`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `divulga` VALUES (18,'www.feicebuqui.com/Associação_dos_profissionais'),(2,'www.feicebuqui.com/Conselho_da_Biologia'),(12,'www.feicebuqui.com/Conselho_da_Biologia'),(17,'www.feicebuqui.com/Conselho_da_Biologia'),(4,'www.feicebuqui.com/Conselho_econômico'),(8,'www.feicebuqui.com/Conselho_econômico'),(20,'www.feicebuqui.com/Conselho_econômico'),(35,'www.feicebuqui.com/Conselho_econômico'),(34,'www.feicebuqui.com/Myxr'),(31,'www.feicebuqui.com/Sentri'),(6,'www.feicebuqui.com/Sindicato_artistico'),(10,'www.feicebuqui.com/Sindicato_artistico'),(15,'www.feicebuqui.com/Sindicato_artistico'),(19,'www.feicebuqui.com/Sindicato_artistico'),(22,'www.feicebuqui.com/Sindicato_artistico'),(23,'www.feicebuqui.com/Sindicato_artistico'),(5,'www.feicebuqui.com/Sindicato_dos_psicólogos'),(7,'www.feicebuqui.com/Uniesquina'),(11,'www.feicebuqui.com/Uniesquina'),(25,'www.feicebuqui.com/Uniesquina'),(33,'www.feicebuqui.com/Uniesquina'),(1,'www.feicebuqui.com/Universidade_SCG'),(13,'www.feicebuqui.com/Universidade_SCG'),(21,'www.feicebuqui.com/Universidade_SCG'),(32,'www.feicebuqui.com/Universidade_SCG');
...
CREATE TABLE `entidade` (
  ...
  `Tip_Universidade` char(1) NOT NULL,
  `Tip_Empresa` char(1) NOT NULL,
  `Tip_Conselho` char(1) NOT NULL,
  `Tip_Associacao` char(1) NOT NULL,
  `Tip_Sindicato` char(1) NOT NULL,
  PRIMARY KEY (`ID_Entidade`),
  UNIQUE KEY `FKResponsavel_ID` (`CPF`),
  UNIQUE KEY `ID_Entidade_IND` (`ID_Entidade`),
  UNIQUE KEY `FKResponsavel_IND` (`CPF`),
  UNIQUE KEY `SID_Ent_Pessoa_IND` (`CPF`),
  CONSTRAINT `FKResponsavel_FK` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `entidade` VALUES (1,10089321162,34246898000102,'Universidade SCG','79776 Chelsea Crescent','1','0','0','0','0'),(2,79580496412,47092217000132,'Uniesquina','48680 Garnet Ferry','1','0','0','0','0'),(3,72360474812,17690757000157,'Sentri','574 Schulist Throughway','0','1','0','0','0'),(4,97657457376,12311029000173,'Myxr','3505 Asha Island','0','1','0','0','0'),(5,4657782754,11508702000105,'Conselho da Biologia','624 Franecki Crossroad','0','0','1','0','0'),(6,98216250290,3320986000175,'Conselho econômico','987 Vella Knoll','0','0','1','0','0'),(7,56706009083,29196748000193,'Associação dos profissionais','7150 Torp Mission','0','0','0','1','0'),(8,70193238209,2677645000199,'Associação dos estudantes','8272 Connell Plaza','0','0','0','1','0'),(9,51782730281,69115881000192,'Sindicato dos psicólogos','90399 Goyette Corner','0','0','0','0','1'),(10,10426777948,50766198000197,'Sindicato artistico','908 Corkery Light','0','0','0','0','1');
...
CREATE TABLE `equipamento` (
  `No_Ativo` int(11) NOT NULL,
  `tipo_equipamento` varchar(200) DEFAULT NULL,
  `Data_Compra` date NOT NULL,
  `Valor` int(11) NOT NULL,
  `ID_Sala` char(1) NOT NULL,
  `CNPJ_Local` bigint(20) NOT NULL,
  PRIMARY KEY (`No_Ativo`),
  UNIQUE KEY `ID_Equipamento_IND` (`No_Ativo`),
  KEY `FKEquipado_com_IND` (`CNPJ_Local`),
  CONSTRAINT `EQU_Equip_Local_FK` FOREIGN KEY (`CNPJ_Local`) REFERENCES `local` (`CNPJ_Local`),
  CONSTRAINT `FKEquipado_com_FK` FOREIGN KEY (`CNPJ_Local`) REFERENCES `local` (`CNPJ_Local`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `equipamento` VALUES (1,'Projetor','2010-08-29',1000,'1',93152678000170),(2,'Lousa','2012-01-10',100,'1',49423741000174),(3,'Microfone e equipamento de som','2000-05-15',10000,'2',10175464000192),(4,'Palco','1999-12-09',2000,'3',80599449000157),(5,'Televisores','2016-02-17',500,'2',57109101713800);
...
CREATE TABLE `evento` (
  `ID_Evento` char(20) NOT NULL,
  `nome_evento` char(200) DEFAULT NULL,
...
INSERT INTO `evento` VALUES ('1','Feira da tecnologia',12,'Computação'),('2','Semana da vida',5,'Biologia'),('3','Matemágica',30,'Matemática'),('4','Culinária para todos',2,'Gastronomia'),('5','Entrando na sua mente',1,'Psicologia'),('6','Enriquecendo',15,'Economia'),('7','Festival do lazer',20,'Artes e Cultura');
...
CREATE TABLE `hospedagem` (
  ...
  PRIMARY KEY (`Reserva_Hospedagem`),
  UNIQUE KEY `ID_Hospedagem_IND` (`Reserva_Hospedagem`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hospedagem` VALUES ('1','2019-08-18',100.00),('2','2019-03-23',50.00),('3','2019-12-28',150.00),('4','2019-07-23',200.00),('5','2019-10-24',70.00);
...
CREATE TABLE `locacao` (
  `Nota_Locacao` bigint(20) NOT NULL,
  `CNPJ_Local` bigint(20) NOT NULL,
  `VALOR` int(200) DEFAULT NULL,
  `Data` date NOT NULL,
  PRIMARY KEY (`Nota_Locacao`),
  UNIQUE KEY `ID_Locacao_IND` (`Nota_Locacao`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `locacao` VALUES (1,10175464000192,5000,'2019-12-18'),(2,10175464000192,7500,'2019-12-15'),(3,10175464000192,5000,'2019-07-12'),(4,49423741000174,2000,'2019-08-10'),(5,49423741000174,2000,'2019-12-18'),(6,49423741000174,4000,'2019-05-01'),(7,49423741000174,2000,'2019-10-29'),(8,49423741000174,2500,'2019-03-01'),(9,49423741000174,2000,'2019-08-01'),(10,49423741000174,2000,'2019-07-01'),(11,49423741000174,2000,'2019-12-01'),(12,49423741000174,2000,'2019-05-10'),(13,57109101713800,1000,'2019-07-12'),(14,57109101713800,1000,'2019-07-13'),(15,57109101713800,1000,'2019-08-06'),(16,57109101713800,1000,'2019-08-12'),(17,80599449000157,10000,'2019-03-20'),(18,80599449000157,10000,'2019-03-27'),(19,80599449000157,10000,'2019-12-22'),(20,93152678000170,3000,'2019-10-30'),(21,93152678000170,3000,'2019-09-18'),(22,93152678000170,3000,'2019-07-20'),(23,93152678000170,3000,'2019-10-24'),(24,93152678000170,3000,'2019-10-18'),(25,93152678000170,3000,'2019-08-11'),(26,93152678000170,3000,'2019-03-17'),(27,93152678000170,3000,'2019-05-04'),(28,93152678000170,3000,'2019-09-14'),(29,93152678000170,3000,'2019-08-19'),(30,93152678000170,3000,'2019-03-24'),(31,93152678000170,3000,'2019-12-29'),(32,93152678000170,3000,'2019-07-24'),(33,93152678000170,3000,'2019-10-25');
...
CREATE TABLE `local` (
  ...
  `Sala_Reuniao` bigint(20) DEFAULT NULL,
  `Auditorio` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`CNPJ_Local`),
  UNIQUE KEY `ID_Local_IND` (`CNPJ_Local`),
  CONSTRAINT `EXTONE_Local` CHECK ((((`Sala_Reuniao` is not null) and (`Auditorio` is null)) or ((`Sala_Reuniao` is null) and (`Auditorio` is not null))))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `local` VALUES (10175464000192,'352 Sonya Center','Arena Big',0,NULL,1),(49423741000174,'87750 Dusty Forest','Coworking Space',5,1,NULL),(57109101713800,'13405 Marquardt Point','Town Hall',2,1,NULL),(80599449000157,'5029 Schuster Extensions','Parque Verde',0,NULL,1),(93152678000170,'2860 Pfannerstill Islands','Anfiteatro',0,NULL,1);
...
CREATE TABLE `loja` (
  ...
  `Atuacao` char(10) NOT NULL,
  PRIMARY KEY (`CNPJ_Loja`),
  UNIQUE KEY `ID_Loja_IND` (`CNPJ_Loja`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `loja` VALUES (31513697000128,'Tstore','Souvenirs'),(34544011000154,'Storela','Papelaria'),(59055965000124,'Spack','Livros'),(68812697000139,'Chare','Comida'),(80000025000124,'Decore','Roupas');
...
CREATE TABLE `lucro` (
  ...
  `ID_Patrocinio` char(1) NOT NULL,
  `ID_Evento` char(20) NOT NULL,
  UNIQUE KEY `FKLuc_Tax_IND` (`ID_Inscricao`),
  UNIQUE KEY `ID_Lucro_TaxInsc_IND` (`ID_Inscricao`),
  KEY `FKLuc_Eve_IND` (`ID_Evento`),
  KEY `EQU_Lucro_Evnt_IND` (`ID_Evento`),
  CONSTRAINT `EQU_Lucro_Evnt_FK` FOREIGN KEY (`ID_Evento`) REFERENCES `evento` (`ID_Evento`),
  CONSTRAINT `ID_Lucro_TaxInsc_FK` FOREIGN KEY (`ID_Inscricao`) REFERENCES `taxa_inscricao` (`ID_Inscricao`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lucro` VALUES (1,'1','1'),(2,'2','2'),(3,'3','3'),(4,'4','1'),(5,'5','2'),(6,'6','4'),(7,'1','2'),(8,'2','3'),(9,'3','4'),(10,'4','6'),(11,'5','7'),(12,'6','1'),(13,'1','2'),(14,'2','4'),(15,'3','5'),(16,'4','6'),(17,'5','7'),(18,'6','2'),(19,'1','3'),(20,'2','4'),(21,'3','5'),(22,'4','6'),(23,'5','7'),(24,'6','1'),(25,'1','2'),(26,'2','3'),(27,'3','4'),(28,'4','5'),(29,'5','6'),(30,'6','7'),(31,'1','1'),(32,'3','2'),(33,'4','3'),(34,'5','4'),(35,'6','5'),(36,'1','6'),(37,'2','7'),(38,'3','1'),(39,'4','2'),(40,'5','3'),(41,'6','4'),(42,'1','5'),(43,'2','6'),(44,'3','7'),(45,'4','1'),(46,'5','2'),(47,'6','3'),(48,'1','4'),(49,'2','5'),(50,'3','6'),(51,'4','7'),(52,'5','1'),(53,'6','2'),(54,'1','3'),(55,'2','4'),(56,'3','5'),(57,'4','6'),(58,'5','7'),(59,'6','1'),(60,'1','2'),(61,'2','3'),(62,'3','4'),(63,'4','5'),(64,'5','6'),(65,'6','7'),(66,'1','1'),(67,'2','2'),(68,'3','3'),(69,'4','4'),(70,'5','5'),(71,'6','6'),(72,'1','6'),(73,'2','1'),(74,'3','2'),(75,'4','3'),(76,'5','4'),(77,'6','5'),(78,'1','6'),(79,'2','7'),(80,'3','1'),(81,'4','2'),(82,'5','3'),(83,'6','4'),(84,'1','5'),(85,'2','6'),(86,'3','7'),(87,'4','1'),(88,'5','2'),(89,'6','3'),(90,'1','4'),(91,'2','5'),(92,'3','6'),(93,'4','7'),(94,'5','1'),(95,'6','2'),(96,'1','3'),(97,'2','4'),(98,'3','5'),(99,'4','6'),(100,'5','7'),(101,'6','1'),(102,'1','2'),(103,'2','3'),(104,'3','4'),(105,'4','5'),(106,'5','6');
/*!40000 ALTER TABLE `lucro` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `material_escritorio`
--

DROP TABLE IF EXISTS `material_escritorio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `material_escritorio` (
  `Nota_compra` bigint(20) NOT NULL,
  `valor` decimal(5,2) NOT NULL,
  `tipos_material` char(15) NOT NULL,
  `Quantidade` int(11) NOT NULL,
  PRIMARY KEY (`Nota_compra`),
  UNIQUE KEY `ID_Material_Escritorio_IND` (`Nota_compra`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `material_escritorio`
--

LOCK TABLES `material_escritorio` WRITE;
/*!40000 ALTER TABLE `material_escritorio` DISABLE KEYS */;
INSERT INTO `material_escritorio` VALUES (1,100.00,'Caneta',100),(2,300.00,'Papel',150),(3,50.00,'Lápis',50),(4,100.00,'Borracha',50),(5,90.00,'grampeador',3);
/*!40000 ALTER TABLE `material_escritorio` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `notas_recibos`
--

DROP TABLE IF EXISTS `notas_recibos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `notas_recibos` (
  `id_pagamento` bigint(20) NOT NULL,
  `ID_Inscricao` bigint(20) NOT NULL,
  `Data` date NOT NULL,
  `CPF_Pagante` bigint(20) NOT NULL,
  `Valor` decimal(5,2) NOT NULL,
  PRIMARY KEY (`id_pagamento`),
  UNIQUE KEY `FKEmite_ID` (`ID_Inscricao`),
  UNIQUE KEY `ID_Notas_Recibos_IND` (`id_pagamento`),
  UNIQUE KEY `FKEmite_IND` (`ID_Inscricao`),
  UNIQUE KEY `SID_NotaRec_TaxInsc_IND` (`ID_Inscricao`),
  CONSTRAINT `FKEmite_FK` FOREIGN KEY (`ID_Inscricao`) REFERENCES `taxa_inscricao` (`ID_Inscricao`),
  CONSTRAINT `SID_NotaRec_TaxInsc_FK` FOREIGN KEY (`ID_Inscricao`) REFERENCES `taxa_inscricao` (`ID_Inscricao`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `notas_recibos`
--

LOCK TABLES `notas_recibos` WRITE;
/*!40000 ALTER TABLE `notas_recibos` DISABLE KEYS */;
INSERT INTO `notas_recibos` VALUES (1,1,'2019-03-01',10089321162,10.00),(2,2,'2019-03-01',79580496412,10.00),(3,3,'2019-03-01',93204873676,10.00),(4,4,'2019-03-17',25631281619,30.00),(5,5,'2019-03-17',48775807351,30.00),(6,6,'2019-03-17',76880861083,30.00),(7,7,'2019-03-20',53260023615,35.00),(8,8,'2019-03-20',60023773600,35.00),(9,9,'2019-03-20',97416461006,35.00),(10,10,'2019-03-24',14429552797,60.00),(11,11,'2019-03-24',50847006409,60.00),(12,12,'2019-03-24',78655763748,60.00),(13,13,'2019-03-27',4657782754,60.00),(14,14,'2019-03-27',56706009083,60.00),(15,15,'2019-03-27',98216250290,60.00),(16,16,'2019-05-01',20482380500,25.00),(17,17,'2019-05-01',48775807351,25.00),(18,18,'2019-05-01',76880861083,25.00),(19,19,'2019-05-01',10089321162,12.00),(20,20,'2019-05-01',50847006409,12.00),(21,21,'2019-05-01',93204873676,12.00),(22,22,'2019-05-04',20482380500,15.00),(23,23,'2019-05-04',48775807351,15.00),(24,24,'2019-05-04',76880861083,15.00),(25,25,'2019-05-10',32571586610,45.00),(26,26,'2019-05-10',53260023615,45.00),(27,27,'2019-05-10',97416461006,45.00),(28,28,'2019-07-01',72360474812,30.00),(29,29,'2019-07-01',79580496412,30.00),(30,30,'2019-07-01',97657457376,30.00),(31,31,'2019-07-12',32571586610,100.00),(32,32,'2019-07-12',53260023615,100.00),(33,33,'2019-07-12',97416461006,100.00),(34,34,'2019-07-12',53260023615,100.00),(35,35,'2019-07-12',60023773600,100.00),(36,36,'2019-07-12',97416461006,100.00),(37,37,'2019-07-13',14429552797,20.00),(38,38,'2019-07-13',20482380500,20.00),(39,39,'2019-07-13',50847006409,20.00),(40,40,'2019-07-20',4657782754,50.00),(41,41,'2019-07-20',97657457376,50.00),(42,42,'2019-07-20',98216250290,50.00),(43,43,'2019-07-24',15514957756,60.00),(44,44,'2019-07-24',78655763748,60.00),(45,45,'2019-07-24',93204873676,60.00),(46,46,'2019-08-01',10089321162,10.00),(47,47,'2019-08-01',72360474812,10.00),(48,48,'2019-08-01',79580496412,10.00),(49,49,'2019-08-06',56706009083,70.00),(50,50,'2019-08-06',70193238209,70.00),(51,51,'2019-08-06',98216250290,70.00),(52,52,'2019-08-10',15514957756,42.00),(53,53,'2019-08-10',53260023615,42.00),(54,54,'2019-08-10',60023773600,42.00),(55,55,'2019-08-11',25631281619,15.00),(56,56,'2019-08-11',32571586610,15.00),(57,57,'2019-08-11',76880861083,15.00),(58,58,'2019-08-12',10426777948,20.00),(59,59,'2019-08-12',15514957756,20.00),(60,60,'2019-08-12',51782730281,20.00),(61,61,'2019-08-12',14429552797,20.00),(62,62,'2019-08-19',20482380500,20.00),(63,63,'2019-08-19',50847006409,20.00),(64,64,'2019-08-19',14429552797,20.00),(65,65,'2019-09-14',20482380500,30.00),(66,66,'2019-09-14',48775807351,30.00),(67,67,'2019-09-14',25631281619,30.00),(68,68,'2019-09-18',32571586610,76.00),(69,69,'2019-09-18',76880861083,76.00),(70,70,'2019-09-18',25631281619,76.00),(71,71,'2019-10-18',32571586610,55.00),(72,72,'2019-10-18',97416461006,55.00),(73,73,'2019-10-18',10426777948,55.00),(74,74,'2019-10-24',51782730281,52.00),(75,75,'2019-10-24',70193238209,52.00),(76,76,'2019-10-24',15514957756,52.00),(77,77,'2019-10-25',60023773600,40.00),(78,78,'2019-10-25',93204873676,40.00),(79,79,'2019-10-25',14429552797,40.00),(80,80,'2019-10-29',20482380500,10.00),(81,81,'2019-10-29',48775807351,10.00),(82,82,'2019-10-29',25631281619,10.00),(83,83,'2019-10-30',32571586610,60.00),(84,84,'2019-10-30',97416461006,60.00),(85,85,'2019-10-30',4657782754,60.00),(86,86,'2019-12-01',72360474812,45.00),(87,87,'2019-12-01',97657457376,45.00),(88,88,'2019-12-01',10426777948,45.00),(89,89,'2019-12-15',15514957756,60.00),(90,90,'2019-12-15',60023773600,60.00),(91,91,'2019-12-15',15514957756,60.00),(92,92,'2019-12-15',53260023615,35.00),(93,93,'2019-12-15',60023773600,35.00),(94,94,'2019-12-15',25631281619,35.00),(95,95,'2019-12-18',48775807351,20.00),(96,96,'2019-12-18',76880861083,20.00),(97,97,'2019-12-18',14429552797,20.00),(98,98,'2019-12-18',50847006409,20.00),(99,99,'2019-12-18',93204873676,20.00),(100,100,'2019-12-18',51782730281,20.00),(101,101,'2019-12-22',56706009083,100.00),(102,102,'2019-12-22',70193238209,100.00),(103,103,'2019-12-22',50847006409,100.00),(104,104,'2019-12-29',78655763748,90.00),(105,105,'2019-12-29',93204873676,90.00),(106,106,'2019-12-29',93204873676,90.00);
/*!40000 ALTER TABLE `notas_recibos` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `oferece` (
  ...
  `ID_Patrocinio` char(1) NOT NULL,
  PRIMARY KEY (`ID_Entidade`),
  UNIQUE KEY `FKOfe_Ent_IND` (`ID_Entidade`),
  UNIQUE KEY `ID_Ofere_Ent_IND` (`ID_Entidade`),
  KEY `FKOfe_Pat_IND` (`ID_Patrocinio`),
  KEY `EQU_Ofere_Patroc_IND` (`ID_Patrocinio`),
  CONSTRAINT `EQU_Ofere_Patroc_FK` FOREIGN KEY (`ID_Patrocinio`) REFERENCES `patrocinio` (`ID_Patrocinio`),
  CONSTRAINT `FKOfe_Ent_FK` FOREIGN KEY (`ID_Entidade`) REFERENCES `entidade` (`ID_Entidade`),
  CONSTRAINT `FKOfe_Pat_FK` FOREIGN KEY (`ID_Patrocinio`) REFERENCES `patrocinio` (`ID_Patrocinio`),
  CONSTRAINT `ID_Ofere_Ent_FK` FOREIGN KEY (`ID_Entidade`) REFERENCES `entidade` (`ID_Entidade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oferece` VALUES (1,1000.00,'6'),(2,2500.00,'5'),(3,10000.00,'1'),(4,8000.00,'2'),(5,6000.00,'3'),(6,10000.00,'1'),(7,4000.00,'4'),(8,1000.00,'6'),(9,2500.00,'5'),(10,4000.00,'4');
...
CREATE TABLE `organiza` (
  ...
  `CPF` bigint(20) NOT NULL,
  PRIMARY KEY (`CPF`,`ID_Atividade`),
  UNIQUE KEY `ID_Organiza_IND` (`CPF`,`ID_Atividade`),
  KEY `FKOrg_Reu_IND` (`ID_Atividade`),
  CONSTRAINT `EQU_Organ_Atvd_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`),
  CONSTRAINT `FKOrg_Pes` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`),
  CONSTRAINT `FKOrg_Reu_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`),
  CONSTRAINT `REF_Organ_Pessoa` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `organiza` VALUES (1,72360474812),(2,4657782754),(3,97657457376),(4,98216250290),(5,51782730281),(6,10426777948),(7,79580496412),(8,98216250290),(9,97657457376),(10,10426777948),(11,79580496412),(12,4657782754),(13,97657457376),(14,97657457376),(15,10426777948),(16,97657457376),(17,4657782754),(18,72360474812),(19,10426777948),(20,98216250290),(21,72360474812),(22,10426777948),(23,10426777948),(24,97657457376),(25,79580496412),(26,98216250290),(27,72360474812),(28,4657782754),(29,79580496412),(30,51782730281),(31,72360474812),(32,4657782754),(33,10426777948),(34,97657457376),(35,98216250290);
...
CREATE TABLE `paga` (
  `ID_Inscricao` bigint(20) NOT NULL,
  `Quantidade_compras` char(1) NOT NULL,
  `data_compra` date DEFAULT NULL,
  `CPF` bigint(20) NOT NULL,
  PRIMARY KEY (`ID_Inscricao`),
  UNIQUE KEY `FKPag_Tax_IND` (`ID_Inscricao`),
  KEY `FKPag_Pes_IND` (`CPF`),
  CONSTRAINT `FKPag_Pes_FK` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`),
  CONSTRAINT `FKPag_Tax_FK` FOREIGN KEY (`ID_Inscricao`) REFERENCES `taxa_inscricao` (`ID_Inscricao`),
  CONSTRAINT `ID_Paga_TaxInsc_FK` FOREIGN KEY (`ID_Inscricao`) REFERENCES `taxa_inscricao` (`ID_Inscricao`),
  CONSTRAINT `REF_Paga_Pessoa_FK` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `paga` VALUES (1,'1','2019-03-01',10089321162),(2,'1','2019-03-01',79580496412),(3,'1','2019-03-01',93204873676),(4,'1','2019-03-17',25631281619),(5,'1','2019-03-17',48775807351),(6,'1','2019-03-17',76880861083),(7,'1','2019-03-20',53260023615),(8,'1','2019-03-20',60023773600),(9,'1','2019-03-20',97416461006),(10,'1','2019-03-24',14429552797),(11,'1','2019-03-24',50847006409),(12,'1','2019-03-24',78655763748),(13,'1','2019-03-27',4657782754),(14,'1','2019-03-27',56706009083),(15,'1','2019-03-27',98216250290),(16,'1','2019-05-01',20482380500),(17,'1','2019-05-01',48775807351),(18,'1','2019-05-01',76880861083),(19,'1','2019-05-01',10089321162),(20,'1','2019-05-01',50847006409),(21,'1','2019-05-01',93204873676),(22,'1','2019-05-04',20482380500),(23,'1','2019-05-04',48775807351),(24,'1','2019-05-04',76880861083),(25,'1','2019-05-10',32571586610),(26,'1','2019-05-10',53260023615),(27,'1','2019-05-10',97416461006),(28,'1','2019-07-01',72360474812),(29,'1','2019-07-01',79580496412),(30,'1','2019-07-01',97657457376),(31,'1','2019-07-12',32571586610),(32,'1','2019-07-12',53260023615),(33,'1','2019-07-12',97416461006),(34,'1','2019-07-12',53260023615),(35,'1','2019-07-12',60023773600),(36,'1','2019-07-12',97416461006),(37,'1','2019-07-13',14429552797),(38,'1','2019-07-13',20482380500),(39,'1','2019-07-13',50847006409),(40,'1','2019-07-20',4657782754),(41,'1','2019-07-20',97657457376),(42,'1','2019-07-20',98216250290),(43,'1','2019-07-24',15514957756),(44,'1','2019-07-24',78655763748),(45,'1','2019-07-24',93204873676),(46,'1','2019-08-01',10089321162),(47,'1','2019-08-01',72360474812),(48,'1','2019-08-01',79580496412),(49,'1','2019-08-06',56706009083),(50,'1','2019-08-06',70193238209),(51,'1','2019-08-06',98216250290),(52,'1','2019-08-10',15514957756),(53,'1','2019-08-10',53260023615),(54,'1','2019-08-10',60023773600),(55,'1','2019-08-11',25631281619),(56,'1','2019-08-11',32571586610),(57,'1','2019-08-11',76880861083),(58,'1','2019-08-12',10426777948),(59,'1','2019-08-12',15514957756),(60,'1','2019-08-12',51782730281),(61,'1','2019-08-12',14429552797),(62,'1','2019-08-19',20482380500),(63,'1','2019-08-19',50847006409),(64,'1','2019-08-19',14429552797),(65,'1','2019-09-14',20482380500),(66,'1','2019-09-14',48775807351),(67,'1','2019-09-14',25631281619),(68,'1','2019-09-18',32571586610),(69,'1','2019-09-18',76880861083),(70,'1','2019-09-18',25631281619),(71,'1','2019-10-18',32571586610),(72,'1','2019-10-18',97416461006),(73,'1','2019-10-18',10426777948),(74,'1','2019-10-24',51782730281),(75,'1','2019-10-24',70193238209),(76,'1','2019-10-24',15514957756),(77,'1','2019-10-25',60023773600),(78,'1','2019-10-25',93204873676),(79,'1','2019-10-25',14429552797),(80,'1','2019-10-29',20482380500),(81,'1','2019-10-29',48775807351),(82,'1','2019-10-29',25631281619),(83,'1','2019-10-30',32571586610),(84,'1','2019-10-30',97416461006),(85,'1','2019-10-30',4657782754),(86,'1','2019-12-01',72360474812),(87,'1','2019-12-01',97657457376),(88,'1','2019-12-01',10426777948),(89,'1','2019-12-15',15514957756),(90,'1','2019-12-15',60023773600),(91,'1','2019-12-15',15514957756),(92,'1','2019-12-15',53260023615),(93,'1','2019-12-15',60023773600),(94,'1','2019-12-15',25631281619),(95,'1','2019-12-18',48775807351),(96,'1','2019-12-18',76880861083),(97,'1','2019-12-18',14429552797),(98,'1','2019-12-18',50847006409),(99,'1','2019-12-18',93204873676),(100,'1','2019-12-18',51782730281),(101,'1','2019-12-22',56706009083),(102,'1','2019-12-22',70193238209),(103,'1','2019-12-22',50847006409),(104,'1','2019-12-29',78655763748),(105,'1','2019-12-29',93204873676),(106,'1','2019-12-29',93204873676);
...
CREATE TABLE `palestra` (
  `ID_Atividade` int(11) NOT NULL,
  `nome_palestra` varchar(200) DEFAULT NULL,
  `afiliacao` varchar(200) DEFAULT NULL,
  `minicurriculo` varchar(200) DEFAULT NULL,
  `Duracao` int(11) NOT NULL,
  `Publico_Alvo` char(15) NOT NULL,
  PRIMARY KEY (`ID_Atividade`),
  UNIQUE KEY `FKAti_Pal_IND` (`ID_Atividade`),
  CONSTRAINT `FKAti_Pal_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`),
  CONSTRAINT `ID_Plsta_Atvd_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `palestra` VALUES (31,'O que é Machine Learning','Sentri','Venha conhecer as principais tecnicas do ML',2,'Estudantes'),(32,'Explicando o aquecimento global','Universidade SCG','Descubra um dos maiores problemas mundiais',1,'Interessados'),(33,'O poder da diversidade','Uniesquina','A importância da diversidade num mundo globalizado',3,'Interessados'),(34,'Culinária e suas infinidades','Myxr','Comida como arte e não apenas como fonte de sobrevivência',4,'Interessados'),(35,'Dinheiro = felicidade?','Conselho econômico','Respondendo uma das maiores dúvidas',2,'Interessados');
...
CREATE TABLE `participa` (
  ...
  `CPF` bigint(20) NOT NULL,
  PRIMARY KEY (`CPF`,`ID_Atividade`),
  UNIQUE KEY `ID_Participa_IND` (`CPF`,`ID_Atividade`),
  KEY `FKPar_Wor_IND` (`ID_Atividade`),
  CONSTRAINT `EQU_Parti_Atvd_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`),
  CONSTRAINT `EQU_Parti_Pessoa` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`),
  CONSTRAINT `FKPar_Pes` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`),
  CONSTRAINT `FKPar_Wor_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `participa` VALUES (1,15514957756),(1,53260023615),(1,60023773600),(2,53260023615),(2,60023773600),(2,97416461006),(3,32571586610),(3,53260023615),(3,97416461006),(4,25631281619),(4,32571586610),(4,97416461006),(5,25631281619),(5,32571586610),(5,76880861083),(6,25631281619),(6,48775807351),(6,76880861083),(7,20482380500),(7,48775807351),(7,76880861083),(8,14429552797),(8,20482380500),(8,48775807351),(9,14429552797),(9,20482380500),(9,50847006409),(10,14429552797),(10,50847006409),(10,93204873676),(11,10089321162),(11,50847006409),(11,93204873676),(12,10089321162),(12,79580496412),(12,93204873676),(13,10089321162),(13,72360474812),(13,79580496412),(14,72360474812),(14,79580496412),(14,97657457376),(15,4657782754),(15,72360474812),(15,97657457376),(16,4657782754),(16,97657457376),(16,98216250290),(17,4657782754),(17,56706009083),(17,98216250290),(18,56706009083),(18,70193238209),(18,98216250290),(19,51782730281),(19,56706009083),(19,70193238209),(20,10426777948),(20,51782730281),(20,70193238209),(21,10426777948),(21,15514957756),(21,51782730281),(22,10426777948),(22,15514957756),(22,60023773600),(23,15514957756),(23,53260023615),(23,60023773600),(24,53260023615),(24,60023773600),(24,97416461006),(25,32571586610),(25,53260023615),(25,97416461006),(26,25631281619),(26,32571586610),(26,97416461006),(27,25631281619),(27,32571586610),(27,76880861083),(28,25631281619),(28,48775807351),(28,76880861083),(29,20482380500),(29,48775807351),(29,76880861083),(30,14429552797),(30,20482380500),(30,48775807351),(31,14429552797),(31,20482380500),(31,50847006409),(32,14429552797),(32,50847006409),(32,78655763748),(33,50847006409),(33,78655763748),(33,93204873676),(34,15514957756),(34,78655763748),(34,93204873676),(35,15514957756),(35,60023773600),(35,93204873676);
/*!40000 ALTER TABLE `participa` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `passagem_aviao`
--

DROP TABLE IF EXISTS `passagem_aviao`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `passagem_aviao` (
  `No_Ticket` char(1) NOT NULL,
  `cod_voo` varchar(20) DEFAULT NULL,
  `Data` date NOT NULL,
  `Valor` int(11) NOT NULL,
  PRIMARY KEY (`No_Ticket`),
  UNIQUE KEY `ID_Passagem_Aviao_IND` (`No_Ticket`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `passagem_aviao`
--

LOCK TABLES `passagem_aviao` WRITE;
/*!40000 ALTER TABLE `passagem_aviao` DISABLE KEYS */;
INSERT INTO `passagem_aviao` VALUES ('1','ABC123','2019-08-17',1000),('2','DEF456','2019-03-22',500),('3','GHI789','2019-12-27',300),('4','JKL123','2019-07-22',2000),('5','MNO456','2019-10-23',9999);
/*!40000 ALTER TABLE `passagem_aviao` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `patrocina` (
  `ID_Entidade` int(11) NOT NULL,
  `ID_Evento` char(20) NOT NULL,
  PRIMARY KEY (`ID_Evento`,`ID_Entidade`),
  UNIQUE KEY `ID_Patrocina_IND` (`ID_Evento`,`ID_Entidade`),
  KEY `FKPat_Ent_IND` (`ID_Entidade`),
  CONSTRAINT `EQU_Patro_Ent_FK` FOREIGN KEY (`ID_Entidade`) REFERENCES `entidade` (`ID_Entidade`),
  CONSTRAINT `EQU_Patro_Evnt` FOREIGN KEY (`ID_Evento`) REFERENCES `evento` (`ID_Evento`),
  CONSTRAINT `FKPat_Ent_FK` FOREIGN KEY (`ID_Entidade`) REFERENCES `entidade` (`ID_Entidade`),
  CONSTRAINT `FKPat_Eve` FOREIGN KEY (`ID_Evento`) REFERENCES `evento` (`ID_Evento`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `patrocina` VALUES (1,'1'),(2,'3'),(3,'1'),(4,'4'),(5,'2'),(6,'6'),(7,'1'),(8,'7'),(9,'5'),(10,'7');
...
CREATE TABLE `patrocinio` (
  ...
  UNIQUE KEY `ID_Patrocinio_IND` (`ID_Patrocinio`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `patrocinio` VALUES ('1','Diamante'),('2','Platina'),('3','Ouro'),('4','Prata'),('5','Bronze'),('6','Ferro');
...
CREATE TABLE `pessoa` (
  ...
  `End_Residencial` char(50) NOT NULL,
  `ID_Entidade` int(11) DEFAULT NULL,
  PRIMARY KEY (`CPF`),
  UNIQUE KEY `ID_Pessoa_IND` (`CPF`),
  KEY `FKFiliado_IND` (`ID_Entidade`),
  KEY `EQU_Pessoa_Ent_IND` (`ID_Entidade`),
  CONSTRAINT `EQU_Pessoa_Ent_FK` FOREIGN KEY (`ID_Entidade`) REFERENCES `entidade` (`ID_Entidade`),
  CONSTRAINT `FKFiliado_FK` FOREIGN KEY (`ID_Entidade`) REFERENCES `entidade` (`ID_Entidade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pessoa` VALUES (4657782754,'Britani','1974-05-28','Britani@email.com',26434377,'908 Marquardt Stream',5),(10089321162,'Enzo','1970-01-11','Enzo@email.com',36988821,'49855 Jaskolski Way',1),(10426777948,'Alida','1979-10-29','Alida@email.com',18922819,'0305 Wisozk Mount',10),(14429552797,'João','1997-08-28','João@email.com',68537965,'58286 Hartmann Mill',NULL),(15514957756,'Helder','1998-09-10','Helder@email.com',79664115,'02463 Patience Junction',NULL),(20482380500,'Aline','1973-01-05','Aline@email.com',65337166,'0079 Wolff Manor',NULL),(25631281619,'Daniela','2000-05-17','Daniela@email.com',28297026,'23442 Crooks Village',NULL),(32571586610,'Julia','1948-12-23','Julia@email.com',48917187,'4331 Keith Trafficway',NULL),(48775807351,'Marcia','1989-02-17','Marcia@email.com',20955746,'5211 Lynch Square',NULL),(50847006409,'Pedro','1974-04-20','Pedro@email.com',73390476,'91662 Powlowski Springs',NULL),(51782730281,'Wilson','1978-09-30','Wilson@email.com',75817467,'908 Marquardt Stream',9),(53260023615,'Gerson','1984-08-28','Gerson@email.com',97298223,'49855 Jaskolski Way',NULL),(56706009083,'Karen','1976-07-03','Karen@email.com',48963037,'0305 Wisozk Mount',7),(59457162510,'Alberto','1969-07-07','Alberto@email.com',19347788,'58286 Hartmann Mill',NULL),(60023773600,'Caio','1970-12-31','Caio@email.com',92695305,'02463 Patience Junction',NULL),(70193238209,'Anderson','1977-08-06','Anderson@email.com',71994647,'0079 Wolff Manor',8),(72360474812,'Matheus','1978-03-09','Matheus@email.com',69996458,'23442 Crooks Village',3),(76880861083,'Mariana','1999-04-01','Mariana@email.com',49250347,'4331 Keith Trafficway',NULL),(77212921661,'Gabriel','1998-05-28','Gabriel@email.com',94271600,'5211 Lynch Square',NULL),(78655763748,'Leticia','1997-09-30','Leticia@email.com',60328644,'91662 Powlowski Springs',NULL),(79580496412,'Jasmine','1971-02-08','Jasmine@email.com',88321480,'908 Marquardt Stream',2),(93204873676,'Sara','1998-07-27','Sara@email.com',77144907,'49855 Jaskolski Way',NULL),(97416461006,'Manuel','1970-08-10','Manuel@email.com',1869836,'0305 Wisozk Mount',NULL),(97657457376,'Elda','1973-05-22','Elda@email.com',41645333,'58286 Hartmann Mill',4),(98216250290,'Alan','1975-06-17','Alan@email.com',26503402,'02463 Patience Junction',6),(132649085785,'Ziggs','1977-01-19','Ziggs@email.com',66038349,'49855 Jaskolski Way',NULL),(650378592564,'Karlos','1964-03-21','Karlos@email.com',87502615,'0079 Wolff Manor',NULL),(875027649212,'Marinda','1984-12-26','Marinda@email.com',94271600,'908 Marquardt Stream',NULL);
...
CREATE TABLE `precisa` (
  ...
  `CPF` bigint(20) NOT NULL,
  PRIMARY KEY (`No_Ticket`),
  UNIQUE KEY `FKPre_Hos_ID` (`Reserva_Hospedagem`),
  UNIQUE KEY `FKPre_Pas_IND` (`No_Ticket`),
  UNIQUE KEY `FKPre_Hos_IND` (`Reserva_Hospedagem`),
  UNIQUE KEY `ID_Preci_PasAviao_IND` (`No_Ticket`),
  KEY `FKPre_Pes_IND` (`CPF`),
  KEY `REF_Preci_Pessoa_IND` (`CPF`),
  CONSTRAINT `FKPre_Hos_FK` FOREIGN KEY (`Reserva_Hospedagem`) REFERENCES `hospedagem` (`Reserva_Hospedagem`),
  CONSTRAINT `FKPre_Pas_FK` FOREIGN KEY (`No_Ticket`) REFERENCES `passagem_aviao` (`No_Ticket`),
  CONSTRAINT `FKPre_Pes_FK` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`),
  CONSTRAINT `ID_Preci_PasAviao_FK` FOREIGN KEY (`No_Ticket`) REFERENCES `passagem_aviao` (`No_Ticket`),
  CONSTRAINT `REF_Preci_Pessoa_FK` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`),
  CONSTRAINT `SID_Preci_Hospdg_FK` FOREIGN KEY (`Reserva_Hospedagem`) REFERENCES `hospedagem` (`Reserva_Hospedagem`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `precisa` VALUES ('1','1',72360474812),('2','2',10089321162),('3','3',79580496412),('4','4',97657457376),('5','5',98216250290);
...
CREATE TABLE `produtos` (
  ...
  UNIQUE KEY `ID_Produtos_IND` (`ID_Produto`),
  KEY `FKVende_FK` (`CNPJ_Loja`),
  KEY `FKCompra_IND` (`CPF`),
  CONSTRAINT `FKCompra_FK` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`),
  CONSTRAINT `FKVende_FK` FOREIGN KEY (`CNPJ_Loja`) REFERENCES `loja` (`CNPJ_Loja`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `produtos` VALUES (1,'Dicionário',50,59055965000124,15514957756),(2,'Revista Científica',30,59055965000124,60023773600),(3,'Chaveiro',1,31513697000128,53260023615),(4,'Bottons',3,31513697000128,97416461006),(5,'Camiseta',45,80000025000124,32571586610),(6,'Moleton',100,80000025000124,25631281619),(7,'Caderno',20,34544011000154,76880861083),(8,'Caneta',5,34544011000154,48775807351),(9,'Coxinha',6,68812697000139,20482380500),(10,'Hamburguer',12,68812697000139,14429552797);
/*!40000 ALTER TABLE `produtos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `promove`
--
...
CREATE TABLE `promove` (
  ...
  `ID_Evento` char(20) NOT NULL,
  PRIMARY KEY (`ID_Evento`,`ID_Entidade`),
  UNIQUE KEY `ID_Promove_IND` (`ID_Evento`,`ID_Entidade`),
  KEY `FKPro_Ent_IND` (`ID_Entidade`),
  KEY `EQU_Promo_Ent_IND` (`ID_Entidade`),
  CONSTRAINT `EQU_Promo_Ent_FK` FOREIGN KEY (`ID_Entidade`) REFERENCES `entidade` (`ID_Entidade`),
  CONSTRAINT `EQU_Promo_Evnt` FOREIGN KEY (`ID_Evento`) REFERENCES `evento` (`ID_Evento`),
  CONSTRAINT `FKPro_Ent_FK` FOREIGN KEY (`ID_Entidade`) REFERENCES `entidade` (`ID_Entidade`),
  CONSTRAINT `FKPro_Eve` FOREIGN KEY (`ID_Evento`) REFERENCES `evento` (`ID_Evento`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `promove`
--

LOCK TABLES `promove` WRITE;
/*!40000 ALTER TABLE `promove` DISABLE KEYS */;
INSERT INTO `promove` VALUES (1,'1'),(2,'3'),(3,'1'),(4,'4'),(5,'2'),(6,'6'),(7,'1'),(8,'7'),(9,'5'),(10,'7');
/*!40000 ALTER TABLE `promove` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `realiza` (
  ...
  `ID_Evento` char(20) NOT NULL,
  PRIMARY KEY (`ID_Evento`,`ID_Entidade`),
  UNIQUE KEY `ID_Realiza_IND` (`ID_Evento`,`ID_Entidade`),
  KEY `FKRea_Ent_IND` (`ID_Entidade`),
  KEY `EQU_Reali_Ent_IND` (`ID_Entidade`),
  CONSTRAINT `EQU_Reali_Ent_FK` FOREIGN KEY (`ID_Entidade`) REFERENCES `entidade` (`ID_Entidade`),
  CONSTRAINT `EQU_Reali_Evnt` FOREIGN KEY (`ID_Evento`) REFERENCES `evento` (`ID_Evento`),
  CONSTRAINT `FKRea_Ent_FK` FOREIGN KEY (`ID_Entidade`) REFERENCES `entidade` (`ID_Entidade`),
  CONSTRAINT `FKRea_Eve` FOREIGN KEY (`ID_Evento`) REFERENCES `evento` (`ID_Evento`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `realiza` VALUES (1,'1'),(2,'3'),(3,'1'),(4,'4'),(5,'2'),(6,'6'),(7,'1'),(8,'7'),(9,'5'),(10,'7');
...
CREATE TABLE `redes_sociais` (
  `URL_pagina` char(50) NOT NULL,
  `nome_pagina` varchar(200) DEFAULT NULL,
  `links` varchar(200) DEFAULT NULL,
  `CNPJ_Loja` bigint(20) NOT NULL,
  PRIMARY KEY (`URL_pagina`),
  UNIQUE KEY `ID_Redes_Sociais_IND` (`URL_pagina`),
  KEY `FKApresenta_sorteados_FK` (`CNPJ_Loja`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `redes_sociais` VALUES ('www.feicebuqui.com/Associação_dos_estudantes','Associação dos estudantes Online',NULL,0),('www.feicebuqui.com/Associação_dos_profissionais','Associação dos profissionais Online',NULL,0),('www.feicebuqui.com/Chare','Chare Digital','www.chare.com',68812697000139),('www.feicebuqui.com/Conselho_da_Biologia','Conselho da Biologia Online',NULL,0),('www.feicebuqui.com/Conselho_econômico','Conselho econômico Online',NULL,0),('www.feicebuqui.com/Decore','DEcore Digital','www.decore.com',80000025000124),('www.feicebuqui.com/Myxr','Myxr Online','www.myxr.com',0),('www.feicebuqui.com/Sentri','Sentri Online','www.sentri.com',0),('www.feicebuqui.com/Sindicato_artistico','Sindicato artistico Online',NULL,0),('www.feicebuqui.com/Sindicato_dos_psicólogos','Sindicato dos psicólogos Online',NULL,0),('www.feicebuqui.com/Spack','Spack Digital','www.spack.com',59055965000124),('www.feicebuqui.com/Storela','Storela Digital','www.storela.com',34544011000154),('www.feicebuqui.com/Tstore','Tstore Digital','www.tstore.com',31513697000128),('www.feicebuqui.com/Uniesquina','Uniesquina Online','www.uniesquina.com',0),('www.feicebuqui.com/Universidade_SCG','Universidade SCG Online','www.uscg.com',0);
...
CREATE TABLE `reuniao` (
  `ID_Atividade` int(11) NOT NULL,
  `Objetivo` char(50) NOT NULL,
  PRIMARY KEY (`ID_Atividade`),
  UNIQUE KEY `FKAti_Reu_IND` (`ID_Atividade`),
  UNIQUE KEY `ID_Reun_Atvd_IND` (`ID_Atividade`),
  CONSTRAINT `FKAti_Reu_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`),
  CONSTRAINT `ID_Reun_Atvd_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reuniao` VALUES (11,'Organizar a Olimpiada de Matemática'),(12,'Organizar a Olimpiada de Biologia'),(13,'Organizar a Olimpiada de Computação'),(14,'Discutir quais pratos cozinhar'),(15,'Discutir quais eventos artísticos apresentar');
...
CREATE TABLE `sala_reuniao` (
  ...
  `Pessoas_Suportadas` int(11) NOT NULL,
  PRIMARY KEY (`CNPJ_Local`),
  UNIQUE KEY `FKLoc_Sal_IND` (`CNPJ_Local`),
  UNIQUE KEY `ID_SaRniao_Local_IND` (`CNPJ_Local`),
  CONSTRAINT `FKLoc_Sal_FK` FOREIGN KEY (`CNPJ_Local`) REFERENCES `local` (`CNPJ_Local`),
  CONSTRAINT `ID_SaRniao_Local_FK` FOREIGN KEY (`CNPJ_Local`) REFERENCES `local` (`CNPJ_Local`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sala_reuniao` VALUES (49423741000174,1,15),(57109101713800,2,20);
/*!40000 ALTER TABLE `sala_reuniao` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `taxa_inscricao`
--

DROP TABLE IF EXISTS `taxa_inscricao`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `taxa_inscricao` (
  ...
  PRIMARY KEY (`ID_Inscricao`),
  UNIQUE KEY `ID_Taxa_Inscricao_IND` (`ID_Inscricao`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `taxa_inscricao`
--

LOCK TABLES `taxa_inscricao` WRITE;
/*!40000 ALTER TABLE `taxa_inscricao` DISABLE KEYS */;
INSERT INTO `taxa_inscricao` VALUES (1,'2019-03-01',10.00,'Dinheiro'),(2,'2019-03-01',10.00,'Débito'),(3,'2019-03-01',10.00,'Crédito'),(4,'2019-03-17',30.00,'Dinheiro'),(5,'2019-03-17',30.00,'Débito'),(6,'2019-03-17',30.00,'Crédito'),(7,'2019-03-20',35.00,'Dinheiro'),(8,'2019-03-20',35.00,'Débito'),(9,'2019-03-20',35.00,'Crédito'),(10,'2019-03-24',60.00,'Dinheiro'),(11,'2019-03-24',60.00,'Débito'),(12,'2019-03-24',60.00,'Crédito'),(13,'2019-03-27',60.00,'Dinheiro'),(14,'2019-03-27',60.00,'Débito'),(15,'2019-03-27',60.00,'Crédito'),(16,'2019-05-01',25.00,'Dinheiro'),(17,'2019-05-01',25.00,'Débito'),(18,'2019-05-01',25.00,'Crédito'),(19,'2019-05-01',12.00,'Dinheiro'),(20,'2019-05-01',12.00,'Débito'),(21,'2019-05-01',12.00,'Crédito'),(22,'2019-05-04',15.00,'Dinheiro'),(23,'2019-05-04',15.00,'Débito'),(24,'2019-05-04',15.00,'Crédito'),(25,'2019-05-10',45.00,'Dinheiro'),(26,'2019-05-10',45.00,'Débito'),(27,'2019-05-10',45.00,'Crédito'),(28,'2019-07-01',30.00,'Dinheiro'),(29,'2019-07-01',30.00,'Débito'),(30,'2019-07-01',30.00,'Crédito'),(31,'2019-07-12',100.00,'Dinheiro'),(32,'2019-07-12',100.00,'Débito'),(33,'2019-07-12',100.00,'Crédito'),(34,'2019-07-12',100.00,'Dinheiro'),(35,'2019-07-12',100.00,'Débito'),(36,'2019-07-12',100.00,'Crédito'),(37,'2019-07-13',20.00,'Dinheiro'),(38,'2019-07-13',20.00,'Débito'),(39,'2019-07-13',20.00,'Crédito'),(40,'2019-07-20',50.00,'Dinheiro'),(41,'2019-07-20',50.00,'Débito'),(42,'2019-07-20',50.00,'Crédito'),(43,'2019-07-24',60.00,'Dinheiro'),(44,'2019-07-24',60.00,'Débito'),(45,'2019-07-24',60.00,'Crédito'),(46,'2019-08-01',10.00,'Dinheiro'),(47,'2019-08-01',10.00,'Débito'),(48,'2019-08-01',10.00,'Crédito'),(49,'2019-08-06',70.00,'Dinheiro'),(50,'2019-08-06',70.00,'Débito'),(51,'2019-08-06',70.00,'Crédito'),(52,'2019-08-10',42.00,'Dinheiro'),(53,'2019-08-10',42.00,'Débito'),(54,'2019-08-10',42.00,'Crédito'),(55,'2019-08-11',15.00,'Dinheiro'),(56,'2019-08-11',15.00,'Débito'),(57,'2019-08-11',15.00,'Crédito'),(58,'2019-08-12',15.00,'Dinheiro'),(59,'2019-08-12',20.00,'Débito'),(60,'2019-08-12',20.00,'Crédito'),(61,'2019-08-12',20.00,'Dinheiro'),(62,'2019-08-19',20.00,'Débito'),(63,'2019-08-19',20.00,'Crédito'),(64,'2019-08-19',20.00,'Dinheiro'),(65,'2019-09-14',30.00,'Débito'),(66,'2019-09-14',30.00,'Crédito'),(67,'2019-09-14',30.00,'Dinheiro'),(68,'2019-09-18',76.00,'Débito'),(69,'2019-09-18',76.00,'Crédito'),(70,'2019-09-18',76.00,'Dinheiro'),(71,'2019-10-18',55.00,'Débito'),(72,'2019-10-18',55.00,'Crédito'),(73,'2019-10-18',55.00,'Dinheiro'),(74,'2019-10-24',52.00,'Débito'),(75,'2019-10-24',52.00,'Crédito'),(76,'2019-10-24',52.00,'Dinheiro'),(77,'2019-10-25',40.00,'Débito'),(78,'2019-10-25',40.00,'Crédito'),(79,'2019-10-25',40.00,'Dinheiro'),(80,'2019-10-29',10.00,'Débito'),(81,'2019-10-29',10.00,'Crédito'),(82,'2019-10-29',10.00,'Dinheiro'),(83,'2019-10-30',60.00,'Débito'),(84,'2019-10-30',60.00,'Crédito'),(85,'2019-10-30',60.00,'Dinheiro'),(86,'2019-12-01',45.00,'Débito'),(87,'2019-12-01',45.00,'Crédito'),(88,'2019-12-01',45.00,'Dinheiro'),(89,'2019-12-15',60.00,'Débito'),(90,'2019-12-15',60.00,'Crédito'),(91,'2019-12-15',60.00,'Dinheiro'),(92,'2019-12-15',35.00,'Débito'),(93,'2019-12-15',35.00,'Crédito'),(94,'2019-12-15',35.00,'Dinheiro'),(95,'2019-12-18',20.00,'Débito'),(96,'2019-12-18',20.00,'Crédito'),(97,'2019-12-18',20.00,'Dinheiro'),(98,'2019-12-18',20.00,'Débito'),(99,'2019-12-18',20.00,'Crédito'),(100,'2019-12-18',20.00,'Dinheiro'),(101,'2019-12-22',100.00,'Débito'),(102,'2019-12-22',100.00,'Crédito'),(103,'2019-12-22',100.00,'Dinheiro'),(104,'2019-12-29',90.00,'Débito'),(105,'2019-12-29',90.00,'Crédito'),(106,'2019-12-29',90.00,'Dinheiro');
/*!40000 ALTER TABLE `taxa_inscricao` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `transporte` (
  ...
  `CPF` bigint(20) DEFAULT NULL,
  `Motorista` char(20) NOT NULL,
  `Rota` char(50) NOT NULL,
  `CNPJ_Local` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`Placa_Veiculo`),
  UNIQUE KEY `ID_Transporte_IND` (`Placa_Veiculo`),
  UNIQUE KEY `FKUtiliza_ID` (`CPF`),
  KEY `FKDisponibiliza_FK` (`CNPJ_Local`),
  CONSTRAINT `FKDisponibiliza_FK` FOREIGN KEY (`CNPJ_Local`) REFERENCES `local` (`CNPJ_Local`),
  CONSTRAINT `FKUtiliza_FK` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `transporte` VALUES ('ABC123',14429552797,'Marinda','Azul',10175464000192),('DEF456',70193238209,'Karlos','Verde',49423741000174),('GHI789',132649085785,'Ziggs','Vermelha',57109101713800),('JKL123',51782730281,'Karlos','Amarela',80599449000157),('MNO456',60023773600,'Ziggs','Lilás',93152678000170);
...
CREATE TABLE `tutorial` (
  ...
  `Duracao` varchar(2) NOT NULL,
  `publico_alvo` varchar(200) DEFAULT NULL,
  `valor_inscricao` int(200) DEFAULT NULL,
  PRIMARY KEY (`ID_Atividade`),
  UNIQUE KEY `FKAti_Tut_IND` (`ID_Atividade`),
  CONSTRAINT `FKAti_Tut_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`),
  CONSTRAINT `ID_Ttrl_Atvd_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tutorial` VALUES (1,'Aprendendo a desenvolver websites','6','Estudantes',200),(2,'Criando o seu próprio jardim','3','Interessados',100),(3,'Como fazer sushi','1','Profissionais da área',1000),(4,'Entendendo a bolsa de valores em 5 passos','5','Interessados',3000),(5,'Mudando o mindset','8','Interessados',500);
/*!40000 ALTER TABLE `tutorial` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `vai_para`
--
...
CREATE TABLE `vai_para` (
  ...
  UNIQUE KEY `ID_Vai_para_IND` (`CPF`,`ID_Evento`),
  KEY `FKVai_Eve_IND` (`ID_Evento`),
  KEY `EQU_Vai_p_Evnt_IND` (`ID_Evento`),
  CONSTRAINT `EQU_Vai_p_Evnt_FK` FOREIGN KEY (`ID_Evento`) REFERENCES `evento` (`ID_Evento`),
  CONSTRAINT `EQU_Vai_p_Pessoa` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`),
  CONSTRAINT `FKVai_Eve_FK` FOREIGN KEY (`ID_Evento`) REFERENCES `evento` (`ID_Evento`),
  CONSTRAINT `FKVai_Pes` FOREIGN KEY (`CPF`) REFERENCES `pessoa` (`CPF`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vai_para`
--

LOCK TABLES `vai_para` WRITE;
/*!40000 ALTER TABLE `vai_para` DISABLE KEYS */;
INSERT INTO `vai_para` VALUES ('1',10089321162),('1',10426777948),('1',14429552797),('1',15514957756),('1',20482380500),('1',25631281619),('1',32571586610),('1',50847006409),('1',51782730281),('1',53260023615),('1',56706009083),('1',60023773600),('1',70193238209),('1',72360474812),('1',76880861083),('1',79580496412),('1',98216250290),('2',4657782754),('2',10089321162),('2',14429552797),('2',25631281619),('2',48775807351),('2',50847006409),('2',53260023615),('2',56706009083),('2',60023773600),('2',76880861083),('2',78655763748),('2',79580496412),('2',93204873676),('2',97416461006),('2',98216250290),('3',10089321162),('3',20482380500),('3',32571586610),('3',48775807351),('3',50847006409),('3',53260023615),('3',76880861083),('3',93204873676),('3',97416461006),('4',4657782754),('4',14429552797),('4',15514957756),('4',20482380500),('4',25631281619),('4',32571586610),('4',48775807351),('4',53260023615),('4',60023773600),('4',76880861083),('4',78655763748),('4',79580496412),('4',93204873676),('4',97416461006),('4',97657457376),('4',98216250290),('5',14429552797),('5',20482380500),('5',25631281619),('5',32571586610),('5',48775807351),('5',76880861083),('6',10426777948),('6',14429552797),('6',15514957756),('6',20482380500),('6',25631281619),('6',32571586610),('6',48775807351),('6',51782730281),('6',60023773600),('6',70193238209),('6',93204873676),('6',97416461006),('7',4657782754),('7',10426777948),('7',14429552797),('7',15514957756),('7',25631281619),('7',48775807351),('7',50847006409),('7',51782730281),('7',53260023615),('7',56706009083),('7',60023773600),('7',70193238209),('7',72360474812),('7',76880861083),('7',78655763748),('7',93204873676),('7',97657457376);
/*!40000 ALTER TABLE `vai_para` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `workshop` (
  ...
  `valor_inscricao` int(200) DEFAULT NULL,
  PRIMARY KEY (`ID_Atividade`),
  UNIQUE KEY `FKAti_Wor_IND` (`ID_Atividade`),
  UNIQUE KEY `ID_Wrksp_Atvd_IND` (`ID_Atividade`),
  CONSTRAINT `FKAti_Wor_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`),
  CONSTRAINT `ID_Wrksp_Atvd_FK` FOREIGN KEY (`ID_Atividade`) REFERENCES `atividade` (`ID_Atividade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `workshop` VALUES (6,'Workshop de violão',2,'Interessados',0),(7,'Workshop de Matemática',4,'Estudantes',50),(8,'Workshop de investimento',3,'Interessados',100),(9,'Workshop de culinária arábe',10,'Profissionais da área',200),(10,'Workshop de dança',2,'Interessados',0);
